...
async function PDF(dataBuffer, options) {
	...
	if (!PDFJS) {
		switch (options.version) {
			case "v1.10.100":
				PDFJS = require(`./pdf.js/v1.10.100/build/pdf.js`);
				break;
			case "v1.10.88":
				PDFJS = require(`./pdf.js/v1.10.88/build/pdf.js`);
				break;
			case "v1.9.426":
				PDFJS = require(`./pdf.js/v1.9.426/build/pdf.js`);
				break;
			case "v2.0.550":
				PDFJS = require(`./pdf.js/v2.0.550/build/pdf.js`);
				break;
			default:
				throw new Error(`Invalid pdf.js version: ${options.version}`);
		}
	}
